  ...
  useEffect(() => {
    ...
    debounceTimerRef.current = setTimeout(() => {
      ...
      if (detected !== "linkedin" && detected !== "unknown") {
        clearPreview();
        setErrorMessage(
          `This looks like a ${detected} link. Please paste a LinkedIn URL here or use the ${detected} downloader.`,
        );
        return;
      }
      ...
      <div
        ...
        <h2
          ...
          {activeTab === "photo"
            ...
            : activeTab === "audio"
              ? "Download LinkedIn Audio"
              : "Download LinkedIn Video"}
        </h2>
        <p className="card-muted mb-6">
          {activeTab === "photo"
            ? "Paste a LinkedIn image URL and download it instantly."
            : activeTab === "audio"
              ? "Extract high-quality audio from LinkedIn videos instantly."
              : "Paste a LinkedIn video URL and download it in your preferred quality."}
        </p>
        ...
        <input
          ...
          placeholder={
            activeTab === "photo"
              ? "Paste LinkedIn image URL here..."
              : "Paste LinkedIn video URL here..."
          }
